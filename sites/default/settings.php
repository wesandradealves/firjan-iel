 ...
 * @endcode
 */
$settings['hash_salt'] = 'gZgVz9cNEIND9nTx_e6vUsuiLoabCp5FuG_ap_xxCscPS4I4ZiKS8DPB-WtInyfVG6cKL9eAyQ';
...
$settings['config_sync_directory'] = 'sites/default/files/config_7xvd0b-Mqzd1_2PmpR7RoIwA7d7cRECVQymj3SpZDn4TVsmbSQvbfRT-pmEeS_g33ZcI9YFTjg/sync';

assert_options(ASSERT_ACTIVE, FALSE);

$settings['trusted_host_patterns'][] = '^.*\.cityconnect\.com.br$';

$databases['default']['default'] = array (
  'database' => 'ielfirjancitycon_ielfirjancitycon',
  'username' => 'ielfirjancitycon_ielfirjancityco',
  'password' => 'ielfirjancitycon_ielfirjancityco',
  'prefix' => '',
  'host' => 'localhost',
  'port' => '3306',
